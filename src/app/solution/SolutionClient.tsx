...
/** Products with a published case study, so each card can link into the detail. */
const CASE_STUDY_BY_PRODUCT: Record<string, string> = {
  safeseq: 'safeseq-genomics',
  'amr-lens': 'amr-lens-stewardship',
  safezell: 'safezell-field-sales',
  qms: 'safefood-manager-compliance',
  safekemia: 'safekemia-virtual-lab',
  safeuzazi: 'safeuzazi-maternal-health',
}
      ...
      <main className="pt-28 lg:pt-32 min-h-screen bg-slate-50 text-slate-800">
        ...
        <section className="relative overflow-hidden bg-gradient-to-r from-[#00499E] to-[#0075ba] text-white py-20 lg:py-24">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <Breadcrumbs
              ...
              items={[{ name: 'Products & Services' }]}
            />
            <h1 className="text-4xl lg:text-5xl font-extrabold tracking-tight mb-4 text-white">Products &amp; Services</h1>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center max-w-2xl mx-auto mb-10">
            <span className="text-xs font-semibold uppercase tracking-widest text-[#00499E] mb-2 block">Platforms</span>
            <h2 className="text-3xl lg:text-4xl font-bold text-[#0b1b4d]">Our AI Platforms</h2>
          </div>
              ...
              >
                ...
                <div className="p-8 flex flex-col flex-grow">
                  ...
                  <div className="border-t border-slate-100 pt-6 mt-auto space-y-3">
                    ...
                    {CASE_STUDY_BY_PRODUCT[p.id] && (
                      <Link
                        href={`/case-studies#${CASE_STUDY_BY_PRODUCT[p.id]}`}
                        className="w-full py-2.5 text-slate-500 hover:text-[#00499E] font-semibold rounded-xl text-xs flex items-center justify-center gap-1.5 transition-colors"
                      >
        ...
        {/* Closing CTA */}
        <section className="relative overflow-hidden py-16 border-t border-slate-100">
          ...
          <div className="relative max-w-3xl mx-auto px-4 text-center text-white">
            ...
            <div className="flex flex-wrap justify-center items-center gap-3">
              ...
              >
                Pricing &amp; timelines FAQ
              </Link>
            </div>
          </div>
        </section>

        <RelatedLinks route="/solution" />
      </main>
      <Footer />
    </>
  )
