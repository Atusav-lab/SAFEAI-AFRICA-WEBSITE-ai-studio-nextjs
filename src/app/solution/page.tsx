...
const products = [
  {
    ...
    title: 'SAFESeq',
    category: 'Healthcare',
    subtitle: 'Genomics • Healthcare • Bioinformatics • AI Research • Drug Discovery',
    desc: 'SAFESeq is a powerful web-based AI platform designed for rapid and accurate bioinformatics analysis. It offers a comprehensive suite of features including basic DNA, RNA, and protein analysis, as well as advanced genome prediction. Accelerate your research with AI-driven protein 3D structure prediction, molecular docking, and virtual PCR capabilities.',
