...
import { Landmark, ShieldCheck, Heart, Users, Award, Eye, Target, ArrowRight } from 'lucide-react'
        ...
        <section className="relative overflow-hidden bg-gradient-to-r from-[#00499E] to-[#0075ba] text-white py-20 lg:py-24">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <Breadcrumbs
              ...
              items={[{ name: 'About Us', href: '/about-us' }, { name: 'Our Company' }]}
            />
        ...
        <section className="py-16 bg-slate-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 text-center">
              ...
              >
                See our work in detail <ArrowRight size={16} />
              </Link>
            </div>
          </div>
        </section>

        <RelatedLinks route="/company" />
      </main>
      <Footer />
    </>
  )
