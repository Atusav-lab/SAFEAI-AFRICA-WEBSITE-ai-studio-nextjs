...
const searchIndex = [
  ...
  },
  {
    ...
    href: '/contact-us',
    tags: 'contact phone email locations help partner collaborate support message form map directions response time',
  },
  {
    title: 'Case Studies',
    desc: 'Detailed build stories behind SAFESeq, AMR Lens Africa, SafeZell, SafeFood Manager, SAFEKemia and SAFEUZAZI AI.',
    href: '/case-studies',
    tags: 'case studies portfolio projects work examples results clients delivery',
  },
  {
    title: 'Frequently Asked Questions',
    desc: 'How projects start, what they cost, how long they take, who owns the data and IP, deployment options and support.',
    href: '/faq',
    tags: 'faq questions pricing cost timeline data ownership support security deployment',
  },
  {
    title: 'Media Gallery',
    desc: 'Photos from showcases, accelerator programmes, ideathons and research work across our projects.',
    href: '/our-gallery',
    tags: 'gallery photos media images events showcase biomic ideathon',
  },
  {
    title: 'Privacy Policy',
    desc: 'What personal data we collect, why we collect it, how long we keep it, and how to exercise your data rights.',
    href: '/privacy-policy',
    tags: 'privacy policy data protection cookies gdpr rights retention',
  },
  {
    title: 'Terms of Service',
    desc: 'The terms governing use of this website and our services, including acceptable use and intellectual property.',
    href: '/terms-of-service',
    tags: 'terms service legal conditions liability intellectual property',
  },
]
      ...
      <main className="pt-20 lg:pt-24 min-h-screen bg-slate-50">
        ...
        <section className="relative overflow-hidden bg-gradient-to-r from-[#00499E] to-[#0075ba] text-white py-12">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <Breadcrumbs variant="dark" className="mb-4 [&>ol]:justify-center" items={[{ name: 'Search' }]} />
            <h1 className="text-3xl font-extrabold tracking-tight text-white">Search Site</h1>
          </div>
        </section>
