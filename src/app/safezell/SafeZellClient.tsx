      ...
      <div className="sz-body bg-[#f7f8f6] text-[#1a1a1a] overflow-x-hidden">
        ...
        <section id="hero" className="min-h-screen pt-[100px] pb-20 px-6 md:px-12 grid md:grid-cols-2 gap-16 items-center relative overflow-hidden">
          ...
          <div className="relative z-10 sz-hero-left">
            <Breadcrumbs
              className="mb-5"
              items={[{ name: 'Products & Services', href: '/solution' }, { name: 'SafeZell' }]}
            />
            ...
            {/* Internal links out of the hero */}
            <p className="mt-5 text-[.875rem] text-[#5a5a5a] font-light">
              Read the{' '}
              <Link href="/case-studies#safezell-field-sales" className="text-[#1565c0] font-medium hover:underline">
                SafeZell case study
              </Link>{' '}
              or browse{' '}
              <Link href="/solution" className="text-[#1565c0] font-medium hover:underline">
                all our platforms
              </Link>
              .
            </p>
