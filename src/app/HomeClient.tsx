...
import {
  ...
  ShieldCheck, Cpu, Globe, ArrowRight
} from 'lucide-react'
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 min-h-[calc(100vh-5rem)] flex items-center">
        <div className="grid lg:grid-cols-2 gap-12 items-center w-full py-16">
          ...
          <motion.div
            ...
            {/* Response-time promise, visible with the primary CTA */}
            <ResponseTimePromise className="mt-5" />

            {/* Primary internal links into the deeper site, above the fold */}
            <p className="mt-5 text-sm text-gray-600 font-lato">
              Explore our{' '}
              <a href="/case-studies" className="text-[#0061B2] font-semibold hover:underline">case studies</a>,{' '}
              <a href="/solution" className="text-[#0061B2] font-semibold hover:underline">AI platforms</a> or{' '}
              <a href="/faq" className="text-[#0061B2] font-semibold hover:underline">frequently asked questions</a>.
            </p>
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-start">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-8 border border-blue-100 shadow-md text-center">
                ...
                <div className="rounded-xl overflow-hidden shadow-lg">
                  <Image
                    ...
                    alt="Sisonkebiotik certificate awarded to SAFE AI-AFRICA"
                    width={1200}
                    height={848}
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-[#0061B2] to-[#082da3] rounded-2xl p-8 shadow-xl text-white relative overflow-hidden">
              ...
              <h3 className="text-xl font-bold text-white mb-3">Independently recognised</h3>
              <p className="text-blue-100 leading-relaxed mb-6">
                SAFESeq was selected among the Top 15 startups in Uganda&apos;s BIOMIC Accelerator Program,
                coordinated by The Lung Institute at Makerere University, funded by STI-OP and implemented
                with Hindsight Ventures.
              </p>
              <a
                href="/blog/safeseq-biomic-accelerator-top-15"
                className="inline-flex items-center gap-2 bg-white/10 border border-white/25 text-white font-semibold px-5 py-2.5 rounded-xl text-sm hover:bg-white/20 transition-colors"
              >
            ...
            <TiltCard>
              <div className="rounded-2xl overflow-hidden shadow-lg relative">
                <Image
                  ...
                  alt="The SAFE AI-AFRICA team building Africa's AI future"
                  width={1200}
                  height={861}
                  sizes="(min-width: 1024px) 50vw, 100vw"
...
const blogPosts = [
  ...
  },
  {
    ...
    alt: 'AI-assisted primary healthcare in a sub-Saharan African clinic',
  ...
  },
  {
    ...
    alt: 'Precision farming powered by AI soil analytics in Kenya',
  ...
  },
  {
    ...
    alt: 'Digital and AI skills training session for South African learners',
  ...
  return (
    <>
      ...
      <main>
        ...
        <BlogSection />
        <CTASection />
        <RelatedLinks route="/" title="Where to next" subtitle="The pages most visitors head to from here." />
      </main>
      <Footer />
    </>
  )
