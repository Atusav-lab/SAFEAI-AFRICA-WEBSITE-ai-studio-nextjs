    ...
    <>
      ...
      <main className="pt-28 lg:pt-32 min-h-screen bg-slate-50 text-slate-800 flex flex-col justify-between">
        ...
        <section className="flex-grow py-8 lg:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col justify-center">
          <Breadcrumbs className="mb-8" items={[{ name: 'Training & Careers' }]} />
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              {/* Secondary paths while the academy is being built */}
              <p className="text-sm text-slate-500 font-lato pt-2">
                Looking for something sooner? Explore our{' '}
                <Link href="/solution" className="text-[#00499E] font-semibold hover:underline">AI platforms</Link>,{' '}
                read the{' '}
                <Link href="/case-studies" className="text-[#00499E] font-semibold hover:underline">case studies</Link>{' '}
                or{' '}
                <Link href="/contact-us" className="text-[#00499E] font-semibold hover:underline">talk to us about team training</Link>.
              </p>
            </div>
        ...
        <RelatedLinks route="/coming-soon" />
      </main>
      <Footer />
    </>
  )
