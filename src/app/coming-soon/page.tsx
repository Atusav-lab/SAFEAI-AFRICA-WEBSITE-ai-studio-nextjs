        ...
        <section className="flex-grow py-8 lg:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col justify-center">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="flex gap-2 bg-slate-800 p-1.5 rounded-xl border border-slate-700">
                    <input
                      ...
                      className="flex-grow bg-transparent px-4 py-2.5 text-sm focus:outline-none placeholder-slate-400 text-white"
                    />
                    <button
                      type="submit"
            ...
            <div className="relative flex justify-center mt-4 lg:mt-0">
              <div className="hidden lg:block absolute w-72 h-72 bg-cyan-500/20 rounded-full filter blur-[100px] animate-pulse" />
