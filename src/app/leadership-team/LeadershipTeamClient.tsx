  ...
  return (
    <>
      ...
      <main className="pt-20 lg:pt-24 min-h-screen bg-slate-50 text-slate-800">
        ...
        <section className="relative overflow-hidden bg-gradient-to-r from-[#00499E] to-[#0075ba] text-white py-16 lg:py-20">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <Breadcrumbs
              ...
              items={[{ name: 'About Us', href: '/about-us' }, { name: 'Leadership Team' }]}
            />
            <h1 className="text-4xl lg:text-5xl font-extrabold tracking-tight mb-4 text-white">Our Leadership Team</h1>
              ...
              >
                ...
                <div className="relative h-72 w-full bg-slate-100 overflow-hidden">
                  {member.image ? (
                    <Image
                      src={member.image}
                      alt={`${member.name}, ${member.role} at SAFE AI-AFRICA`}
                      fill
        ...
        <RelatedLinks route="/leadership-team" />
      </main>
      <Footer />
    </>
  )
